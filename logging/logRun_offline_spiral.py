'''
Log all evaluation plots from offline spiral bearingNet script 
Author: mfirlefyn
...
# evaluation cycle, directory already exist because it is needed to evaluate
    ...
    logRunFiles(positions_in_epoch_path,"positions_in_epoch.png",log_dir_path)

    logRunFiles(gaze_angles_in_epoch_path,"gaze_angles_in_epoch.png",log_dir_path)
